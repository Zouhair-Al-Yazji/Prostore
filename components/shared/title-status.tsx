...
const steps = [
	...
	{ title: 'Shipping Address', icon: BookUser },
	{ title: 'Payment Method', icon: CreditCard },
	{ title: 'Place Order', icon: ListTodo },
];

export default function TitleStatus({ current }: { current: number }) {
							...
							>
								...
								<div className="flex flex-col items-start gap-1">
									...
									<div>
										...
										<Badge className="hidden bg-green-500 group-data-[state=completed]/step:inline-flex">
											Completed
										</Badge>
